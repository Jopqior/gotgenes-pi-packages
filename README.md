...
| [@jopqior/pi-subagents](./packages/pi-subagents/)                               | Focused, in-process autonomous sub-agent core for Pi           | [![npm](https://img.shields.io/npm/dm/@jopqior/pi-subagents)](https://www.npmjs.com/package/@jopqior/pi-subagents)                               |
| [@jopqior/pi-subagents-model-selector](./packages/pi-subagents-model-selector/) | Per-spawn model and thinking selection for pi-subagents        | [![npm](https://img.shields.io/npm/dm/@jopqior/pi-subagents-model-selector)](https://www.npmjs.com/package/@jopqior/pi-subagents-model-selector) |
